...
public class guestClassEeeSections extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guest_class_eee_sections);
        ...
        eeeA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(guestClassEeeSections.this, guestClassDetails.class);
